...
export type ContextType = {
    MyDerazaStyles: { styles: string, arka: boolean ,foiz:number ,price:number,}[],
    setMyDerazaStyles: React.Dispatch<React.SetStateAction<{ styles: string, arka: boolean ,foiz:number ,price:number}[]>>,
    ProfilRagng: string,
...
const GlobalProvayder = ({ children }: ChildrenType) => {
    const [MyDerazaStyles, setMyDerazaStyles] = useState<{ styles: string, arka: boolean,foiz:number ,price:number}[]>([])
